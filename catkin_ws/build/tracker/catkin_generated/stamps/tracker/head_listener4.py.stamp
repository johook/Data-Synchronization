...
def callback_depth(depth_image):
    global blue1, pink2, yellow1	
    bridge = CvBridge()
    img_depth = bridge.imgmsg_to_cv2(depth_image)

    blue1.z = img_depth[blue1.y][blue1.x]
    blue1.projection()
    ...
    first = point_pub('first',blue1.X*0.001,blue1.Y*0.001,blue1.Z*0.001)
...
def callback2(image):
    global blue1, pink2, pink3, yellow1, yellow2
    bridge = CvBridge()
    img = bridge.imgmsg_to_cv2(image,"bgr8")
    img = cv2.circle(img, (320,240), 5, (0,0,255), 2) # x y

    blue1.circle(img,(255, 0, 0))
    pink2.circle(img,(0, 0, 255))
...
p_color_lower = (60, 95, 55) 
p_color_high = (130, 255, 245)

y_color_lower = (20, 80, 30)
y_color_high = (30, 255, 255)


b_color_lower = (115, 35, 35)
b_color_high = (180, 225, 255)

#b_color_lower = (90, 85, 40)
#b_color_high = (170, 175, 255)





blue1 = find_circle(b_color_lower,b_color_high)
