...
if __name__ == "__main__":
    ...
    pub_raw_eye = rospy.Publisher('/vector_raweye', Marker, queue_size=10)
...
#------------------------------------------------------ 
    ...
    while not rospy.is_shutdown():
        ...
        line0 = tracker.r0 - tracker.v0
        line1 = tracker.r1 - tracker.v0
...
#---TODO : get yaw pitch roll , and matmul with v_eye---------------------------------------
        ...
        e1 =tuple(e1)
        v_eye = tracker.gp
        marker_raw_eye = make_marker(v_eye * 999999 +p_driver , p_driver, [0.5, 0, 0])
